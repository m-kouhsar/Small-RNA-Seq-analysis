...
#SBATCH --output=mintmap.%A_%a.out
#SBATCH --array=0-19
#########################################################################################
#########################################################################################
...
lookuptable="./MINTmap_github/LookupTable.tRFs.MINTmap_v1.txt"
tRNAsequences="./MINTmap_github/tRNAspace.Spliced.Sequences.MINTmap_v1.fa"
tRFtypes="./MINTmap_github/OtherAnnotations.MINTmap_v1.txt"
MINTplatesPath=./MINTmap_github/MINTplates/
